...
cur_url=replaceAll(cur_url,"http://www.vr186.com","http://m.vr186.com");
cur_url=replaceAll(cur_url,"http://vr186.com","http://m.vr186.com");
...
function showWindow(k, url, mode, cache, menuv) {
	...
	var fetchContent = function() {
		...
		if(parseInt(BROWSER.ie) != 6) {
			loadingst = setTimeout(function() {showDialog('', 'info', '<img src="bbs/' + IMGDIR + '/loading.gif"> ���Ժ�...')}, 500);
		}
	};
