$(function(){
	/*$('document').delegate('#fullBtn','click',function (){
		if($('.username').parent().hasClass('checkedN') && $('.email').parent().hasClass('checkedN')){
			$('#mainForm1').submit();
			return false;
			//return true;
			//&& $(".checkboxPic").attr('isshow') == "true"
		}else{
			alert('aaa');
			//return false;
		}
	...
	/*$('#mainForm2').submit(function (){
		if($('.username').parent().hasClass('checkedN') && $('.email').parent().hasClass('checkedN') && $(".checkboxPic").attr('isshow') == 'true'){
			return true;
		}else{
			return false;
		}
	...
	$(".username").blur(function(){
        ...
        else
        {
    		...
    		$.ajax({
    			type:'POST',
    			url:'check',
    			data:"username="+value+"&op=username",
    			datatype:'text',
